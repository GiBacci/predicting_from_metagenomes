...
```{r genesPlot, fig.width=5, fig.height=3, fig.cap="Figure 3: Tukey post-hoc test results. Different COG categories are reported following standard notation. Bars represent the mean contribution for each category whereas error bars represent the upper confidence limit for the observations."}
# Tukey post-hoc test
...
```{r taxaContribPlot, fig.width=6, fig.height=6, fig.height=3, fig.cap="Figure 4: Average contribution of bacterial species on the selected variables."}
# Mean plotting
